...
highlight("Number", { fg = colors.dark_magenta })
highlight("Boolean", { fg = colors.dark_yellow, italic = true })
highlight("Float", { fg = colors.dark_magenta })
...
highlight("Special", { fg = colors.dark_magenta })
...
highlight("@markup.raw.block.markdown", { fg = colors.green })
